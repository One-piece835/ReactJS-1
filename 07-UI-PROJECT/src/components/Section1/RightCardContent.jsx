...
const RightCardContent = (props) => {
  return (
    <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
        ...
        <div>
        <p className='text-shadow-2xs leading-relaxed text-white mb-10'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Culpa sit similique ipsa molestias esse beatae?</p> 
        <div className='flex'>
